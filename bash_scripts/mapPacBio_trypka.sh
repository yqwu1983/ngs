...
outm1=$spec_1$lib1"_mapped_only.fq"
outm2=$spec_1$lib2"_mapped_only.fq"
outm3=$spec_1$lib3"_mapped_only.fq"
outm4=$spec_1$lib4"_mapped_only.fq"
outm5=$spec_2$lib1"_mapped_only.fq"
outm6=$spec_2$lib2"_mapped_only.fq"
outm7=$spec_2$lib3"_mapped_only.fq"
outm8=$spec_2$lib4"_mapped_only.fq"
outm9=$spec_3$lib1"_mapped_only.fq"
outm10=$spec_3$lib2"_mapped_only.fq"
outm11=$spec_3$lib3"_mapped_only.fq"
outm12=$spec_3$lib4"_mapped_only.fq"
outm13=$spec_4$lib1"_mapped_only.fq"
outm14=$spec_4$lib2"_mapped_only.fq"
outm15=$spec_4$lib3"_mapped_only.fq"
outm16=$spec_4$lib4"_mapped_only.fq"
...
mapPacBio.sh in=$genomic_MP ref=$ref1 nodisk out=$out2 outm=$outm2 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats2 covhist=$covhist2 basecov=$basecov2 bincov=$bincov2
mapPacBio.sh in=$transcriptomic_polyA ref=$ref1 nodisk out=$out3 outm=$outm3 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats3 covhist=$covhist3 basecov=$basecov3 bincov=$bincov3
mapPacBio.sh in=$transcriptomic_ribominus ref=$ref1 nodisk out=$out4 outm=$outm4 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats4 covhist=$covhist4 basecov=$basecov4 bincov=$bincov4
#
mapPacBio.sh in=$genomic_PE ref=$ref2 nodisk out=$out5 outm=$outm5 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats5 covhist=$covhist5 basecov=$basecov5 bincov=$bincov5
mapPacBio.sh in=$genomic_MP ref=$ref2 nodisk out=$out6 outm=$outm6 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats6 covhist=$covhist6 basecov=$basecov6 bincov=$bincov6
mapPacBio.sh in=$transcriptomic_polyA ref=$ref2 nodisk out=$out7 outm=$outm7 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats7 covhist=$covhist7 basecov=$basecov7 bincov=$bincov7
mapPacBio.sh in=$transcriptomic_ribominus ref=$ref2 nodisk out=$out8 outm=$outm8 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats8 covhist=$covhist8 basecov=$basecov8 bincov=$bincov8
#
mapPacBio.sh in=$genomic_PE ref=$ref3 nodisk out=$out9 outm=$outm9 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats9 covhist=$covhist9 basecov=$basecov9 bincov=$bincov9
mapPacBio.sh in=$genomic_MP ref=$ref3 nodisk out=$out10 outm=$outm10 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats10 covhist=$covhist10 basecov=$basecov10 bincov=$bincov10
mapPacBio.sh in=$transcriptomic_polyA ref=$ref3 nodisk out=$out11 outm=$outm11 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats11 covhist=$covhist11 basecov=$basecov11 bincov=$bincov11
mapPacBio.sh in=$transcriptomic_ribominus ref=$ref3 nodisk out=$out12 outm=$outm12 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats12 covhist=$covhist12 basecov=$basecov12 bincov=$bincov12
#
mapPacBio.sh in=$genomic_PE ref=$ref4 nodisk out=$out13 outm=$outm13 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats13 covhist=$covhist13 basecov=$basecov13 bincov=$bincov13
mapPacBio.sh in=$genomic_MP ref=$ref4 nodisk out=$out14 outm=$outm14 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats14 covhist=$covhist14 basecov=$basecov14 bincov=$bincov14
mapPacBio.sh in=$transcriptomic_polyA ref=$ref4 nodisk out=$out15 outm=$outm15 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats15 covhist=$covhist15 basecov=$basecov15 bincov=$bincov15
mapPacBio.sh in=$transcriptomic_ribominus ref=$ref4 nodisk out=$out16 outm=$outm16 vslow k=8 maxindel=200 minratio=0.1 covstats=$covstats16 covhist=$covhist16 basecov=$basecov16 bincov=$bincov16
